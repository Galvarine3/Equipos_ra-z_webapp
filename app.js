...
// git remote add origin https://github.com/Galvarine3/Equipos_ra-z_webapp
...
// y vuelve a crearlo: git remote add origin https://github.com/Galvarine3/Equipos_ra-z_webapp
...
async function loadPlayersRemote() {
  try {
    const res = await fetch('players.json', { headers: { 'Accept': 'application/json' } });
...
async function savePlayersRemote(players) {
  // Static site mode: no remote persistence
  return false;
}
